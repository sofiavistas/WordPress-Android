 ...
 */
public class WPNestedScrollView extends FrameLayout implements NestedScrollingParent,
     ...
     *
     * @see #setOnScrollChangeListener(WPNestedScrollView.OnScrollChangeListener)
     */
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(WPNestedScrollView v, int scrollX, int scrollY,
    ...
    private WPNestedScrollView.SavedState mSavedState;

    private static final WPNestedScrollView.AccessibilityDelegate
            ACCESSIBILITY_DELEGATE = new WPNestedScrollView.AccessibilityDelegate();
    ...
    private WPNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;
     ...
     */
    public void setOnScrollChangeListener(WPNestedScrollView.OnScrollChangeListener l) {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof WPNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        WPNestedScrollView.SavedState
                ss = (WPNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        WPNestedScrollView.SavedState
                ss = new WPNestedScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<WPNestedScrollView.SavedState> CREATOR =
                new Parcelable.Creator<WPNestedScrollView.SavedState>() {
                    @Override
                    public WPNestedScrollView.SavedState createFromParcel(Parcel in) {
                        return new WPNestedScrollView.SavedState(in);
                    }

                    @Override
                    public WPNestedScrollView.SavedState[] newArray(int size) {
                        return new WPNestedScrollView.SavedState[size];
                    }
                };
    }
